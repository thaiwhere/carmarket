...
BEGIN
	...
	SELECT distinct c.CarId, u.UserId, c.IsNew, c.IsImport, c.[year], c.Firm as FirmName, c.Title, c.[Description], c.Km, c.GearBox, c.CurrencyVN, p.Name as Province, u.UserName ContactName, u.Tel ContactTel, 0  as IsBuy
	...
	SELECT distinct b.CarId, u.UserId, b.IsNew, b.IsImport, b.[year], b.Firm as FirmName, b.Title, b.[Description], b.Km, b.GearBox, b.[PriceFromVN] as CurrencyVN , p.Name as Province, u.UserName ContactName, u.Tel ContactTel, 1 as IsBuy
